...
// Validate ../../src/app/(projects)/physicsx/page.tsx
{
  type __IsExpected<Specific extends AppPageConfig<"/physicsx">> = Specific
  const handler = {} as typeof import("../../src/app/(projects)/physicsx/page.js")
  type __Check = __IsExpected<typeof handler>
  // @ts-ignore
  type __Unused = __Check
}
