...
const ICO_Arrival = (props: SVGProps<SVGSVGElement>) => {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width="40" height="20" viewBox="0 0 40 20" fill="none" {...props}>
      <path d="M10 8.74228e-07H30V5H10V8.74228e-07Z" fill="var(--c-on-surface)"/>
