          ...
          <div className={styles.group}>
            ...
            <div className={`${styles.list}`}>
              <ul>
                <li>
                  Development,{" "}
                  <XLink href={URL.HANHANXUE} target="_blank" rel="noopener">
                    Han Han Xue<sup>↗</sup>
                  </XLink>
                </li>
                <li>
                  Hosting,{" "}
                  <XLink href={URL.VERCEL} target="_blank" rel="noopener">
                    Vercel<sup>↗</sup>
                  </XLink>
                </li>
                <li>
                  Analytics,{" "}
                  <XLink href={URL.PLAUSIBLE} target="_blank" rel="noopener">
                    Plausible<sup>↗</sup>
                  </XLink>
                </li>
              </ul>
          ...
          <div className={styles.group}>
            ...
            <div className={`${styles.list}`}>
              <ul>
                ...
                <li>
                  <XLink href={URL.GITHUB} target="_blank" rel="noopener">
                    Github<sup>↗</sup>
                  </XLink>
                </li>
                <li>
                  <XLink href={URL.INSTAGRAM} target="_blank" rel="noopener">
                    Instagram<sup>↗</sup>
                  </XLink>
                </li>
                <li>
                  <XLink href={URL.YOUTUBE} target="_blank" rel="noopener">
                    YouTube<sup>↗</sup>
                  </XLink>
                </li>
              </ul>
